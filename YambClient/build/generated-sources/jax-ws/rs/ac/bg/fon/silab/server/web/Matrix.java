 ...
 *       &lt;sequence>
 *         &lt;element name="fields" type="{http://web.server.silab.fon.bg.ac.rs/}fieldArray" maxOccurs="unbounded" minOccurs="0"/>
...
public class Matrix {
    ...
    protected List<FieldArray> fields;
    @XmlElement(nillable = true)
    ...
    public List<FieldArray> getFields() {
        if (fields == null) {
            fields = new ArrayList<FieldArray>();
        }
        return this.fields;
    }
