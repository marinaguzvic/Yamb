 ...
 * @author MARINA
 */
public class ThrowDicesSO extends AbstractGenericSO {
    ...
    public void switchState(RequestObject requestObject) throws Exception {
        participation.setState(participation.getState().throwDices(requestObject.getDices()));
    }
    ...
    public String getMessage(int status) {
        if(status == 1){
            return "Kockice su uspesno bacene";
        }else{
            return "Sistem nije uspeo da baci kockice";
        }
    }
