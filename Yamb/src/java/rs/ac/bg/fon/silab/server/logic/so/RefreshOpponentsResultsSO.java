 ...
 * @author MARINA
 */
public class RefreshOpponentsResultsSO extends AbstractGenericSO {
    ...
    public String getMessage(int status) {
        if (status == 1) {
            return "Sistem je uspesno pronasao trenutne rezultate";
        } else {
            return "Sistem ne moze da pronadje trenutne rezultate";
        }
    }
