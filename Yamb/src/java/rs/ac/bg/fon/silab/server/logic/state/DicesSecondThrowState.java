 ...
 * @author MARINA
 */
public class DicesSecondThrowState extends PlayState {
    ...
    public PlayState throwDices(java.lang.Integer[] dicesKept) {
        ...
        DicesThirdThrowState state = new DicesThirdThrowState();
    ...
    public PlayState najavi(Long najavaRow) throws Exception {
        throw new Exception("Trying to perform najavi after second throw");
    }
